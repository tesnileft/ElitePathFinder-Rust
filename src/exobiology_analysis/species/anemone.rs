...
pub fn predict_anemone(planet_class: &PlanetClass, atmosphere: &AtmosphereInfo, volcanism: Volcanism, temperature: f64, startypes: &Vec<&Star>) -> Vec<ExoBiologySpecies> {
